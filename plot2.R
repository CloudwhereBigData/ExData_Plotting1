## coursera Plot2 for ExData - Script 01/08/2015

##This Script will read data from the household power consumption and display
##a plot of type line for the global active power by date for a subset of dates
...
## Open PNG device; create 'plot2.png' in my working directory 480x480
